...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Editar una imagen')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="<?php echo e($action); ?>">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <button type="submit" class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"><?php echo e(__("Editar Imagen")); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/images/edit.blade.php ENDPATH**/ ?>